...
if (!isset($_SESSION)) {//Verificar se a sessão não já está aberta.
  session_start();}
    ...
    //Consulta SQL 
    include "sql/p/listar/sql_visitante.php";
...
$sqlestudo = mysqli_query($conn , "SELECT *, sum(estudo) estudo_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
$sqlencontro = mysqli_query($conn , "SELECT *, sum(encontro) encontro_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
$sqlestudosbiblicos = mysqli_query($conn , "SELECT *, sum(estudosbiblicos) estudosbiblicos_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
//-----------------------------------------Acao Soliária------------------------------------------------
//VRF o valor de acao
$sqlacao = mysqli_query($conn , "SELECT *, sum(acao) acao_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
$sqlpresenca = mysqli_query($conn , "SELECT *, sum(presenca) presenca_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
//-----------------------------------------contato------------------------------------------------
//VRF o valor de presenca
$sqlcontato = mysqli_query($conn , "SELECT *, sum(contato) contato_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
$sqlqtd_alunos = mysqli_query($conn , "SELECT *, count(niveis_acesso_id) qtd_alunos FROM usuarios WHERE classe = $classe");
...
//-----------------------------------------QTD Visitas Adventistas------------------------------------------------
  $resultado_adventista_sabado = mysqli_query($conn , "SELECT sum(adventista) adventista_sabado1 FROM apontamento WHERE dataapontamento=$dataapontamento AND classe = $numerologin");
...
//-----------------------------------------QTD Visitas Não Adventistas------------------------------------------------
  $resultado_naoadventista_sabado = mysqli_query($conn , "SELECT sum(naoadventista) naoadventista_sabado1 FROM apontamento WHERE dataapontamento=$dataapontamento AND classe = $numerologin");
...
$sqloferta = mysqli_query($conn , "SELECT *, sum(oferta) oferta_sabado FROM apontamento WHERE dataapontamento=$dataapontamento AND classe=$classe");
...
$sqlalvodeoferta = mysqli_query($conn , "SELECT *, sum(alvodeoferta) valor_oferta FROM classes WHERE numerodaclasse = $classe");
...
//echo "--------oferta sabado---------- $ofertasabado";
			...
			$total_qtdofertas = (($ofertasabado*100)/$valordeoferta);
						...
						<body>
						<h1><center> <?php  echo "Data: $dataapontamento2  ";?> </center></h1>
