...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading"><center><font color="#39a35b"> <?php echo "$dia";?></font></center> </div>
      <div class="sidebar-heading"><center><font color="#39a35b"> <?php echo "$usuario_logado";?></font></center> </div>

      <div class="list-group list-group-flush">
        <a href="administrativo.php" class="list-group-item list-group-item-action bg-light">Inicio</a>
        <a href="cad_check.php" class="list-group-item list-group-item-action bg-light">+ Apontamento</a>
        <a href="cad_usuario_aluno.php" class="list-group-item list-group-item-action bg-light">+ Aluno</a>
        <a href="cad_usuario_visitante.php" class="list-group-item list-group-item-action bg-light">+ Visitante</a>
        <a href="cad_classe.php" class="list-group-item list-group-item-action bg-light">+ Classe</a>
        <a href="cad_pontuacao.php" class="list-group-item list-group-item-action bg-light">+ Pontuacao</a>
        <a href="cad_1000.php" class="list-group-item list-group-item-action bg-light">+ Atividade</a>
        <a href="listar_aluno.php" class="list-group-item list-group-item-action bg-light">Listar Alunos</a>
        <a href="listar_visitante.php" class="list-group-item list-group-item-action bg-light">Listar VIsitantes</a>
        <a href="listar_classe.php" class="list-group-item list-group-item-action bg-light">Listar Classes</a>
        <a href="listar_apontamento.php" class="list-group-item list-group-item-action bg-light">Listar Apontamentos</a>
        <a href="listar_pontuacao.php" class="list-group-item list-group-item-action bg-light">Listar Pontuacao</a>
        <a href="termometro_menu.php" class="list-group-item list-group-item-action bg-light">Termometro</a>
        <a href="sair.php" class="list-group-item list-group-item-action bg-light">Sair</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
              ...
              <a class="dropdown-item" href="administrativo.php">Inicio</a>
