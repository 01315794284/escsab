...
/*	$impressao = '<table border=1';	
	...
	$result_alunos = "SELECT classe,presenca,acao,encontro,contato,estudo,estudosbiblicos,oferta FROM apontamento where dataapontamento=$dataapontamento2 order by classe ";
