...
$dataapontamento  =$_SESSION['dataapontamentos'];
$classe  = $_SESSION['classes'];
  ...
  $sqlqtd_alunos = mysqli_query($conn_alunos , "SELECT *, count(classe) qtd_alunos FROM usuarios WHERE classe = $classe");
  ...
  <div class="col-md-12">
    <form class="form-horizontal" method="POST" action="processa/proc_cad_apontamento.php">
      ...
      <div class="form-group">
        <font color="#0B3B39"><label for="inputEmail3" class="col-sm-2 control-label">Classe</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="classe" required="" readonly="readonly" value="<?php echo $_SESSION['classes'];?>">
          </div>
      </div>

      <div class="form-group">
        <font color="#0B3B39"><label for="inputEmail3" class="col-sm-2 control-label">Data Apontamento</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="dataapontamento" required="" readonly="readonly" value="<?php echo $_SESSION['dataapontamentos'];?>">
          </div>
      </div>
  ...
  <font color=<?php echo $relacionamento;?>><h2>Relacionamento</h2></font>
      <div class="form-group">
        <font color="#0B3B39"><label for="inputEmail3" class="col-sm-2 control-label">Quantos membros estao presentes*</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="presenca" required="" readonly="readonly" value="<?php echo $_SESSION['qtdalunospresente'];?>" max="<?php echo "$qtd_alunos_total" ?>" placeholder="O numero maximo que pode colocar e <?php echo "$qtd_alunos_total" ?> ">
          </div>
      </div>
