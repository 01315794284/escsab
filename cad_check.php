...
$dia = date("d/m/Y");
  ...
  $resultado=mysqli_query($conn, "SELECT nome, id_usuarios, classe FROM usuarios ORDER BY classe");
  $linhas=mysqli_num_rows($resultado);
//Pegando só o id
  $resultado_id=mysqli_query($conn, "SELECT id_usuarios FROM usuarios");
