...
<html lang="pt-br">
  ...
  <h1><center>Cadastrar Visitante</center></h1>
  </div>
  
  <div class="row">
  <div class="col-md-12">
    <form class="form-horizontal" method="POST" action="processa/p_proc_cad_usuario_visitante.php" autocomplete="off">
      ...
      <div class="col-sm-10">
        <select class="form-control" name="numerodaclasse" required="">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group date">
              <input type="date" class="form-control" name="datacadastro" id="datacadastro" value="<?php echo"$data";  ?>">
              <div class="input-group-addon">
                <span class="glyphicon glyphicon-th"></span>
              </div>
            </div>
