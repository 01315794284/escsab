...
/*	$impressao = '<table border=1';	
	...
	$result_alunos = "SELECT classe,presenca,acao,encontro,contato,estudo,estudosbiblicos,oferta FROM apontamento where dataapontamento=$dataapontamento2 and classe=$classe order by classe ";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h2 style="text-align: center;"><img src="imagens/logoclasse.jpeg">Termômetro Classe</h2>
			'. $impressao .'
		');
	...
	//Exibibir a página
	$dompdf->stream(
		"Termometro_Classe_Esc_Sab_Fonseca.pdf", 
		array(
