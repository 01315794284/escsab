...
// Aniversariantes
$mes_atual = date("m");
$resultado_aniversario=mysqli_query($conn, "SELECT * FROM usuarios WHERE Month(datanascimento) = '$mes_atual' ORDER BY datanascimento, classe, nome");
...
<?php while($linhas_aniversario = mysqli_fetch_assoc($resultado_aniversario)){ ?>
                <tr>
                  ...
                  <td><center><?php echo $linhas_aniversario['classe']; ?></center></td>
